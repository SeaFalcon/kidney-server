...
module.exports = (app) => {
  ...
  app.post('/peritoneum-memo', jwtMiddleware, uploadMiddleware.single('image'), dialysis.savePeritonrumMemo);
  app.get('/hemodialysis-memo', jwtMiddleware, dialysis.getHemodialysisMemo);
  app.get('/peritoneum-memo', jwtMiddleware, dialysis.getPeritonrumMemo);
  app.put('/hemodialysis-memo', jwtMiddleware, uploadMiddleware.single('image'), dialysis.changeHemodialysisMemo);
  app.put('/peritoneum-memo', jwtMiddleware, uploadMiddleware.single('image'), dialysis.changePeritonrumMemo);
